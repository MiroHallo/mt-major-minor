...
#      movementson strike-slip and reverse faults in inland Japan, Earth,
...
CURRENT_EVENT = TrinityClass(
    ...
    mt_major=np.array([0.2192, 1.4434, -1.6626, 0.58336, -0.035697, -0.5216]),
    mt_minor=np.array([0.8875, 0.09331, -0.98077, -0.32336, 0.1157, -0.1984]),
    ratio_major=0.632,
    ratio_minor=0.368,
    facecolor='red',
)
...
def main():
    ...
    - Read moment tensors and scalar seismic moment ratio from CURRENT_EVENT.
    - Plot trinity of beach-balls.
